...
},{"../languages/en":22,"../utils/general":37,"./mejs":6}],5:[function(require,module,exports){
'use strict';
...
var MediaElement = function MediaElement(idOrNode, options) {
  ...
  */
	t.mediaElement.changeRenderer = function (rendererName, mediaFiles) {
		...
		try {
			for (var _iterator = rendererArray[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  */
	...
	var props = _mejs2.default.html5media.properties,
		...
		if (propName !== 'src') {
			(function () {
				...
				(0, _general.addProperty)(t.mediaElement, propName, getFn, setFn);
		...
		if (typeof value === 'string') {
			...
			try {
				for (var _iterator2 = value[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					...
					var src = (0, _media.absolutizeUrl)(val.src),
					    type = val.type;
	...
	(0, _general.addProperty)(t.mediaElement, 'src', getSrc, setSrc);
...
},{"../utils/general":37,"../utils/media":39,"./mejs":6,"./renderer":7,"global/document":2,"global/window":3}],6:[function(require,module,exports){
'use strict';
		...
		value: function select(mediaFiles) {
			...
			try {
				for (var _iterator = renderers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					...
					var _renderer = this.renderers[key];
					...
					if (_renderer !== null && _renderer !== undefined) {
						...
						try {
							...
							for (var _iterator2 = mediaFiles[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
								var file = _step2.value;

								if (typeof _renderer.canPlayType === 'function' && typeof file.type === 'string' && _renderer.canPlayType(file.type)) {
									return {
...
Object.assign(_player.config, {
	...
	// demo of a fullscreen option
	{
		render: function render(player) {
			...
			if (player.isFullScreen) {
				return _i18n2.default.t('mejs.fullscreen-off');
			} else {
				return _i18n2.default.t('mejs.fullscreen-on');
			}
		},
	...
	// demo of a mute/unmute button
	{
		render: function render(player) {
			if (player.media.muted) {
				return _i18n2.default.t('mejs.unmute');
			} else {
				return _i18n2.default.t('mejs.mute');
			}
		},
		click: function click(player) {
			if (player.media.muted) {
	...
	{
		render: function render(player) {
			return _i18n2.default.t('mejs.download-video');
		},
		click: function click(player) {
...
$.extend(_player.MediaElementPlayer.prototype, {
...
},{"../core/i18n":4,"../player":24}],9:[function(require,module,exports){
'use strict';
  ...
  */
	buildfullscreen: function buildfullscreen(player, controls, layers, media) {
		...
		var t = this,
		    ...
		    fullscreenBtn = $('<div class="' + t.options.classPrefix + 'button ' + t.options.classPrefix + 'fullscreen-button">\n\t\t\t\t\t<button type="button" aria-controls="' + t.id + '" title="' + fullscreenTitle + '" aria-label="' + fullscreenTitle + '"></button>\n\t\t\t\t</div>').appendTo(controls).on('click', function () {
   ...
   */
		...
		var fullscreenIsDisabled = false,
			...
			if (fullscreenIsDisabled) {
				...
				try {
					for (var _iterator = hoverDivs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		try {
			for (var _iterator2 = hoverDivNames[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				var hover = _step2.value;

				hoverDivs[hover] = $('<div class="' + t.options.classPrefix + 'fullscreen-hover" />').appendTo(t.container).mouseover(restoreControls).hide();
			}
		...
		fullscreenBtn.on('mouseover', function () {
			...
			if (!t.isFullScreen) {
				...
				try {
					for (var _iterator3 = hoverDivs[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
						var hover = _step3.value;
...
},{"../core/i18n":4,"../core/mejs":6,"../player":24,"../utils/constants":35,"global/document":2,"global/window":3}],10:[function(require,module,exports){
'use strict';
...
$.extend(_player.MediaElementPlayer.prototype, {
  ...
  */
	buildjumpforward: function buildjumpforward(player, controls, layers, media) {
		var t = this,
		    defaultTitle = _i18n2.default.t('mejs.time-jump-forward', t.options.jumpForwardInterval),
...
},{"../core/i18n":4,"../player":24}],11:[function(require,module,exports){
'use strict';
	...
	buildmarkers: function buildmarkers(player, controls, layers, media) {
		...
		media.addEventListener('timeupdate', function (e) {
			...
			if (player.options.markers.length) {
				...
				try {
					for (var _iterator = player.options.markers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
},{"../player":24}],12:[function(require,module,exports){
'use strict';
  ...
  */
	buildplaypause: function buildplaypause(player, controls, layers, media) {
		var t = this,
		    ...
		    play = $('<div class="' + t.options.classPrefix + 'button ' + t.options.classPrefix + 'playpause-button \n\t\t\t\t\t' + t.options.classPrefix + 'play">\n\t\t\t\t\t<button type="button" aria-controls="' + t.id + '" title="' + playTitle + '" aria-label="' + pauseTitle + '"></button>\n\t\t\t\t</div>').appendTo(controls).click(function () {
			if (media.paused) {
				media.play();
			} else {
				media.pause();
...
},{"../core/i18n":4,"../player":24}],13:[function(require,module,exports){
'use strict';
...
$.extend(_player.MediaElementPlayer.prototype, {
  ...
  */
	buildpostroll: function buildpostroll(player, controls, layers, media) {
		var t = this,
		    postrollTitle = t.options.postrollCloseText ? t.options.postrollCloseText : _i18n2.default.t('mejs.close'),
		    postrollLink = t.container.find('link[rel="postroll"]').attr('href');

		if (postrollLink !== undefined) {
			player.postroll = $('<div class="' + t.options.classPrefix + 'postroll-layer ' + t.options.classPrefix + 'layer">\n\t\t\t\t\t<a class="' + t.options.classPrefix + 'postroll-close" onclick="$(this).parent().hide();return false;">\n\t\t\t\t\t\t' + postrollTitle + '\n\t\t\t\t\t</a>\n\t\t\t\t\t<div class="' + t.options.classPrefix + 'postroll-layer-content"></div>\n\t\t\t\t</div>').prependTo(layers).hide();
...
},{"../core/i18n":4,"../player":24}],14:[function(require,module,exports){
'use strict';
...
},{"../core/i18n":4,"../player":24,"../utils/constants":35,"../utils/time":40}],15:[function(require,module,exports){
'use strict';
...
$.extend(_player.MediaElementPlayer.prototype, {
  ...
  */
	buildskipback: function buildskipback(player, controls, layers, media) {
		var t = this,
		    defaultTitle = _i18n2.default.t('mejs.time-skip-back', t.options.skipBackInterval),
...
},{"../core/i18n":4,"../player":24}],16:[function(require,module,exports){
'use strict';
...
$.extend(_player.MediaElementPlayer.prototype, {
  ...
  */
	buildsourcechooser: function buildsourcechooser(player, controls, layers, media) {
		...
		var t = this,
		    sourceTitle = t.options.sourcechooserText ? t.options.sourcechooserText : _i18n2.default.t('mejs.source-chooser'),
		    hoverTimeout = void 0;
		...
		.on('focusout', (0, _general.debounce)(function () {
...
},{"../core/i18n":4,"../player":24,"../utils/general":37}],17:[function(require,module,exports){
'use strict';
  ...
  */
	buildspeed: function buildspeed(player, controls, layers, media) {
		...
		var playbackSpeed = void 0,
		    inputId = void 0,
		    speedTitle = t.options.speedText ? t.options.speedText : _i18n2.default.t('mejs.speed-rate'),
		    speeds = [],
			...
			try {
				for (var _iterator = speeds[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var speed = _step.value;
		...
		try {
			for (var _iterator2 = t.options.speeds[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				var s = _step2.value;
...
},{"../core/i18n":4,"../player":24}],18:[function(require,module,exports){
'use strict';
...
$.extend(_player.MediaElementPlayer.prototype, {
  ...
  */
	buildstop: function buildstop(player, controls, layers, media) {
		var t = this,
		    stopTitle = t.options.stopText ? t.options.stopText : _i18n2.default.t('mejs.stop');
		...
		$('<div class="' + t.options.classPrefix + 'button ' + t.options.classPrefix + 'stop-button ' + t.options.classPrefix + 'stop">\n\t\t\t\t<button type="button" aria-controls="' + t.id + '" title="' + stopTitle + '" aria-label="' + stopTitle + '"></button>\n\t\t\t</div>').appendTo(controls).click(function () {
			...
			if (media.currentTime > 0) {
				...
				controls.find('.' + t.options.classPrefix + 'time-float-current').html((0, _time.secondsToTimeCode)(0, player.options.alwaysShowHours));
				controls.find('.' + t.options.classPrefix + 'currenttime').html((0, _time.secondsToTimeCode)(0, player.options.alwaysShowHours));
...
},{"../core/i18n":4,"../player":24,"../utils/time":40}],19:[function(require,module,exports){
'use strict';
...
$.extend(_player.MediaElementPlayer.prototype, {
  ...
  */
	buildcurrent: function buildcurrent(player, controls, layers, media) {
		...
		$('<div class="' + t.options.classPrefix + 'time" role="timer" aria-live="off">\n\t\t\t<span class="' + t.options.classPrefix + 'currenttime">' + (0, _time.secondsToTimeCode)(0, player.options.alwaysShowHours) + '</span>\n\t\t</div>').appendTo(controls);
...
},{"../player":24,"../utils/time":40}],20:[function(require,module,exports){
'use strict';
...
$.extend(_player.MediaElementPlayer.prototype, {
  ...
  */
	buildtracks: function buildtracks(player, controls, layers, media) {
		...
		try {
			for (var _iterator = player.tracks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		try {
			for (var _iterator2 = player.tracks[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				var _track = _step2.value;

				kind = _track.kind;
				if (kind === 'subtitles' || kind === 'captions') {
					player.addTrackButton(_track.trackId, _track.srclang, _track.label);
				}
			}
  ...
  */
	setTrack: function setTrack(trackId) {
		...
		try {
			for (var _iterator3 = t.tracks[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
  ...
  */
	checkForTracks: function checkForTracks() {
		...
		if (t.options.hideCaptionsButtonWhenEmpty) {
			...
			try {
				for (var _iterator4 = t.tracks[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
  ...
  */
	displayChapters: function displayChapters() {
		...
		try {
			for (var _iterator5 = t.tracks[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
  ...
  */
	drawChapters: function drawChapters(chapters) {
		...
		for (i = 0; i < total; i++) {
			...
			t.chapters.append($('<div class="' + t.options.classPrefix + 'chapter" rel="' + chapters.entries.times[i].start + '" \n\t\t\t\t \tstyle="left: ' + usedPercent.toString() + '%; width: ' + percent.toString() + '%;">\n\t\t\t\t \t<div class="' + t.options.classPrefix + 'chapter-block \n\t\t\t\t \t' + (i === chapters.entries.length - 1 ? ' ' + t.options.classPrefix + 'chapter-block-last' : '') + '">\n\t\t\t\t\t\t<span class="ch-title">' + chapters.entries[i].text + '</span>\n\t\t\t\t\t\t<span class="ch-time">\n\t\t\t\t\t\t\t' + (0, _time.secondsToTimeCode)(chapters.entries[i].start, t.options.alwaysShowHours) + '\n\t\t\t\t \t\t\t&ndash;\n\t\t\t\t \t\t\t' + (0, _time.secondsToTimeCode)(chapters.entries[i].stop, t.options.alwaysShowHours) + '\n\t\t\t\t\t\t</span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>'));
			usedPercent += percent;
		}
...
},{"../core/i18n":4,"../core/mejs":6,"../player":24,"../utils/time":40}],21:[function(require,module,exports){
'use strict';
...
},{"../core/i18n":4,"../player":24,"../utils/constants":35}],22:[function(require,module,exports){
'use strict';
...
},{"./core/mejs":6}],24:[function(require,module,exports){
'use strict';
...
var MediaElementPlayer = function () {
		...
		value: function _meReady(media, domNode) {
			...
			if (!(_constants.IS_ANDROID && t.options.AndroidUseNativeControls) && !(_constants.IS_IPAD && t.options.iPadUseNativeControls) && !(_constants.IS_IPHONE && t.options.iPhoneUseNativeControls)) {
				var _ret = function () {
					...
					try {
						for (var _iterator = t.options.features[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
   ...
   */
		...
		value: function buildoverlays(player, controls, layers, media) {
			...
			var t = this,
			    loading = $('<div class="' + t.options.classPrefix + 'overlay ' + t.options.classPrefix + 'layer">\n\t\t\t\t\t<div class="' + t.options.classPrefix + 'overlay-loading">\n\t\t\t\t\t\t<span class="' + t.options.classPrefix + 'overlay-loading-bg-img"></span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>').hide() // start out hidden
			.appendTo(layers),
			    error = $('<div class="' + t.options.classPrefix + 'overlay ' + t.options.classPrefix + 'layer">\n\t\t\t\t\t<div class="' + t.options.classPrefix + 'overlay-error"></div>\n\t\t\t\t</div>').hide() // start out hidden
			.appendTo(layers),

			// this needs to come last so it's on top
			bigPlay = $('<div class="' + t.options.classPrefix + 'overlay ' + t.options.classPrefix + 'layer ' + t.options.classPrefix + 'overlay-play">\n\t\t\t\t\t<div class="' + t.options.classPrefix + 'overlay-button" role="button" \n\t\t\t\t\t\taria-label="' + _i18n2.default.t('mejs.play') + '" aria-pressed="false">\n\t\t\t\t\t</div>\n\t\t\t\t</div>').appendTo(layers).on('click', function () {
		...
		value: function onkeydown(player, media, e) {
			...
			if (player.hasFocus && player.options.enableKeyboard) {
				...
				try {
					for (var _iterator2 = player.options.keyActions[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
						var keyAction = _step2.value;
						var _iteratorNormalCompletion3 = true;
						var _didIteratorError3 = false;
						var _iteratorError3 = undefined;

						try {
							for (var _iterator3 = keyAction.keys[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
		...
		value: function remove() {
			...
			try {
				for (var _iterator4 = t.options.features[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
},{"./core/i18n":4,"./core/mediaelement":5,"./core/mejs":6,"./utils/constants":35,"./utils/dom":36,"./utils/general":37,"./utils/time":40,"global/document":2,"global/window":3}],25:[function(require,module,exports){
'use strict';
	...
	create: function create(mediaElement, options, mediaFiles) {
		...
		_window2.default['__ready__' + dm.id] = function (_dmPlayer) {
			...
			if (apiStack.length) {
				...
				try {
					for (var _iterator3 = apiStack[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
			...
			try {
				for (var _iterator4 = events[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
					...
					(0, _dom.addEvent)(dmIframe, event, assignEvent);
				}
			...
			try {
				for (var _iterator6 = initEvents[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
					var initialEvent = _step6.value;

					var _event2 = (0, _dom.createEvent)(initialEvent, dm);
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/dom":36,"../utils/media":39,"global/document":2,"global/window":3}],26:[function(require,module,exports){
'use strict';
		...
		function sendEvents(events) {
			...
			try {
				for (var _iterator3 = events[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
					var initialEvent = _step3.value;

					var event = (0, _dom.createEvent)(initialEvent, fbWrapper);
					mediaElement.dispatchEvent(event);
				}
			} catch (err) {
				_didIteratorError3 = true;
				...
				FB.Event.subscribe('xfbml.ready', function (msg) {
					...
					if (msg.type === 'video') {
						(function () {
							...
							try {
								for (var _iterator4 = fbEvents[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
									var event = _step4.value;
							...
							if (apiStack.length) {
								...
								try {
									for (var _iterator5 = apiStack[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
										var stackItem = _step5.value;
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/dom":36,"../utils/general":37,"../utils/media":39,"global/document":2,"global/window":3}],27:[function(require,module,exports){
'use strict';
	...
	detectPlugin: function detectPlugin(pluginName, mimeType, activeX, axDetect) {
		...
		if (_constants.NAV.plugins !== undefined && _typeof(_constants.NAV.plugins[pluginName]) === 'object') {
			...
			if (description && !(typeof _constants.NAV.mimeTypes !== 'undefined' && _constants.NAV.mimeTypes[mimeType] && !_constants.NAV.mimeTypes[mimeType].enabledPlugin)) {
				...
				try {
					for (var _iterator = version[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	create: function create(mediaElement, options, mediaFiles) {
		...
		_window2.default['__ready__' + flash.id] = function () {
			...
			if (flash.flashApiStack.length) {
				...
				try {
					for (var _iterator4 = flash.flashApiStack[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
},{"../core/i18n":4,"../core/mejs":6,"../core/renderer":7,"../utils/constants":35,"../utils/dom":36,"../utils/media":39,"global/document":2,"global/window":3}],28:[function(require,module,exports){
'use strict';
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/constants":35,"../utils/dom":36,"../utils/media":39,"global/document":2,"global/window":3}],29:[function(require,module,exports){
'use strict';
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/constants":35,"../utils/dom":36,"../utils/media":39,"global/document":2,"global/window":3}],30:[function(require,module,exports){
'use strict';
  ...
  */
	create: function create(mediaElement, options, mediaFiles) {
		...
		if (mediaFiles && mediaFiles.length > 0) {
			...
			try {
				for (var _iterator3 = mediaFiles[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/constants":35,"../utils/dom":36,"global/document":2,"global/window":3}],31:[function(require,module,exports){
'use strict';
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/constants":35,"../utils/dom":36,"../utils/media":39,"global/document":2,"global/window":3}],32:[function(require,module,exports){
'use strict';
  ...
  */
	create: function create(mediaElement, options, mediaFiles) {
		...
		_window2.default['__ready__' + sc.id] = function (_scPlayer) {
			...
			try {
				for (var _iterator4 = initEvents[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
					var initialEvent = _step4.value;

					var event = (0, _dom.createEvent)(initialEvent, sc);
					mediaElement.dispatchEvent(event);
				}
			} catch (err) {
				_didIteratorError4 = true;
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/dom":36,"../utils/media":39,"global/document":2,"global/window":3}],33:[function(require,module,exports){
'use strict';
		...
		_window2.default['__ready__' + vimeo.id] = function (_vimeoPlayer) {
			...
			try {
				for (var _iterator4 = events[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
					...
					(0, _dom.addEvent)(vimeoIframe, _event, assignEvents);
				}
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/dom":36,"../utils/media":39,"global/document":2,"global/window":3}],34:[function(require,module,exports){
'use strict';
			...
			events: {
				onReady: function onReady(e) {
					...
					if (apiStack.length) {
						...
						try {
							for (var _iterator4 = apiStack[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
								var stackItem = _step4.value;
					...
					try {
						for (var _iterator5 = events[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
							...
							(0, _dom.addEvent)(youTubeIframe, event, assignEvents);
						}
					...
					try {
						for (var _iterator6 = initEvents[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
							...
							var _event = (0, _dom.createEvent)(initialEvent, youtube);
...
},{"../core/mejs":6,"../core/renderer":7,"../utils/dom":36,"../utils/media":39,"global/document":2,"global/window":3}],35:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.cancelFullScreen = exports.requestFullScreen = exports.isFullScreen = exports.FULLSCREEN_EVENT_NAME = exports.NATIVE_FULLSCREEN_ENABLED = exports.HAS_TRUE_NATIVE_FULLSCREEN = exports.HAS_IOS_FULLSCREEN = exports.HAS_MS_NATIVE_FULLSCREEN = exports.HAS_MOZ_NATIVE_FULLSCREEN = exports.HAS_WEBKIT_NATIVE_FULLSCREEN = exports.SUPPORTS_NATIVE_HLS = exports.SUPPORTS_MEDIA_TAG = exports.SUPPORT_POINTER_EVENTS = exports.HAS_MSE = exports.HAS_TOUCH = exports.IS_STOCK_ANDROID = exports.IS_SAFARI = exports.IS_FIREFOX = exports.IS_CHROME = exports.IS_IE = exports.IS_ANDROID = exports.IS_IOS = exports.IS_IPHONE = exports.IS_IPAD = exports.UA = exports.NAV = undefined;
...
try {
	for (var _iterator = html5Elements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		var element = _step.value;

		video = _document2.default.createElement(element);
	}
...
var NATIVE_FULLSCREEN_ENABLED = exports.NATIVE_FULLSCREEN_ENABLED = nativeFullScreenEnabled;
...
},{"global/document":2,"global/window":3}],36:[function(require,module,exports){
'use strict';
...
},{"../utils/general":37,"global/document":2}],37:[function(require,module,exports){
'use strict';
 ...
 * @return {HTMLElement[]}
 */
mejs.getElementsByClassName = function (className, node, tag) {
...
},{"global/document":2}],38:[function(require,module,exports){
'use strict';
...
},{"global/document":2}],39:[function(require,module,exports){
'use strict';
...
function getTypeFromFile(url) {
	...
	if (typeChecks.length) {
		...
		try {
			for (var _iterator = typeChecks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	try {
		for (var _iterator2 = typeChecks[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
},{"./general":37}],40:[function(require,module,exports){
'use strict';
...
},{}]},{},[38,5,30,29,31,28,34,33,25,26,32,27,4,22,23,24,12,18,14,19,21,9,17,20,16,8,15,10,13,11]);
